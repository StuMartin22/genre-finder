$(document).ready(function () {
  ...
  var apiUrl =
    "https://ws.audioscrobbler.com/2.0/?method=tag.gettopalbums&tag=rock&limit=10&api_key=38f325c730f4218c2247c79ff7fd0a85&format=json";
  var artistUrl =
    "https://ws.audioscrobbler.com/2.0/?method=tag.gettopartists&tag=rock&limit=10&api_key=38f325c730f4218c2247c79ff7fd0a85&format=json";
      ...
      function (response) {
        ...
        //   albumCoverEl.text(data.albums.album[i].image[1].#text);
          albumCardEl.append(
            $("<img>", {
              id: "albumCover",
            //   src: data.albums.album[i].image[1].#text,
            })
          );
        }
      })
